...
module UART_qsys_master_0 #(
	...
	UART_qsys_master_0_timing_adt timing_adt (
		.clk       (clk_clk),                                    //   clk.clk
	...
	UART_qsys_master_0_b2p_adapter b2p_adapter (
		.clk               (clk_clk),                              //   clk.clk
		.reset_n           (~rst_controller_reset_out_reset),      // reset.reset_n
	...
	UART_qsys_master_0_p2b_adapter p2b_adapter (
		.clk               (clk_clk),                            //   clk.clk
		.reset_n           (~rst_controller_reset_out_reset),    // reset.reset_n
