...
alias elab {
  echo "\[exec\] elab"
  vsim +access +r  -t ps -L work -L master_0 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneii $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -dbg -O2 +access +r -t ps -L work -L master_0 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneii $TOP_LEVEL_NAME
}
