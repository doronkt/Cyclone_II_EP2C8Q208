...
# ACDS 13.0sp1 232 win32 2017.12.02.08:33:17
...
alias com {
  echo "\[exec\] com"
  vcom "$QSYS_SIMDIR/submodules/bcd_master_0.vhd" -work master_0
  vcom "$QSYS_SIMDIR/bcd.vhd"                                   
}
...
alias elab {
  echo "\[exec\] elab"
  vsim -t ps -L work -L work_lib -L master_0 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneii $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -novopt -t ps -L work -L work_lib -L master_0 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneii $TOP_LEVEL_NAME
}
