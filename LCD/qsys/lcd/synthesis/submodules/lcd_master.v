...
// 
// Generated using ACDS version 13.0sp1 232 at 2017.12.30.22:40:15
...
module lcd_master #(
	...
	lcd_master_timing_adt timing_adt (
		.clk       (clk_clk),                                    //   clk.clk
	...
	lcd_master_b2p_adapter b2p_adapter (
		.clk               (clk_clk),                              //   clk.clk
		.reset_n           (~rst_controller_reset_out_reset),      // reset.reset_n
	...
	lcd_master_p2b_adapter p2b_adapter (
		.clk               (clk_clk),                            //   clk.clk
		.reset_n           (~rst_controller_reset_out_reset),    // reset.reset_n
